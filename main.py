    ...
    with get_db() as conn:
        ...
        for drv in drivers:
            ...
            results.append({
                ...
                "total_km":     total_km,
                "days_detail":  days,
                # raw KPI data — score يُحسب بعد اكتمال كل السائقين
